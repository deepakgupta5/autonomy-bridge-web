...
document:
  id: "doc_market_overview_deployment_economics"
  type: "subsection"
  status: "published"
  language: "en"
...
keywords:
  ...
  - "automation ROI by domain"
  - "robotics capital requirements"
  - "utilisation threshold robotics"
  - "automation payback period"
  - "industrial automation deployment cost"
  - "robotics commercial viability economics"
  - "deployment economics platform categories"
...
entities:
  primary_topic: "Robotics and AI Deployment Economics"
  secondary_topics:
    - "Capital Requirements by Platform Category"
    - "Utilisation Thresholds"
    - "Payback Conditions"
    - "Deployment Risk"
    - "Commercial Viability by Operator Domain"
...
internal_links:
  ...
  semantic:
    ...
    - label: "Automation Failure Framework"
...
sections:
  - id: "top"
  - id: "deployment-economics-overview"
...
```json
{
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Deployment Economics", "item": "https://autonomybridge.com/market-overview/deployment-economics" }
    ]
  }
}
```

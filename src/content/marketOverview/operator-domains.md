...
document:
  id: "doc_market_overview_operator_domains"
  type: "subsection"
  status: "published"
  language: "en"
...
keywords:
  - "robotics operator domains"
  - "warehouse automation operator"
  - "healthcare robotics deployment"
  - "agriculture robotics"
  - "construction robotics"
  - "energy infrastructure automation"
  - "industrial automation operator domains"
  - "commercial facilities robotics"
...
entities:
  primary_topic: "Operator Application Domains for Robotics and AI"
  secondary_topics:
...
```json
{
  ...
  "breadcrumb": {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Operator Domains", "item": "https://autonomybridge.com/market-overview/operator-domains" }
    ]
  }
}
```

...
canonical:
  url: "https://autonomybridge.com/insights/what-autonomous-vehicle-companies-get-wrong-about-freight-sales"

robots: "index,follow"

keywords:
  - "autonomous vehicle freight sales"
  - "AV commercial viability"
  - "autonomous trucking go-to-market"
  - "AV cost-per-mile"
  - "autonomous trucking commercial"
  - "AV buyer qualification"
  - "Gatik commercial model"
  - "autonomous vehicle sales cycle"
  - "freight carrier qualification"
  - "autonomous trucking revenue"
...
seo:
  meta_title: "What Autonomous Vehicle Companies Get Wrong About Freight Sales | Autonomy Bridge"
  meta_description: "Only one AV company has contracted commercial freight revenue at scale. Evidence from 23 on-road companies explains why technology milestones don't convert to freight contracts ,  and what freight buyers actually need to see."
  og_title: "What Autonomous Vehicle Companies Get Wrong About Freight Sales"
  og_description: "Gatik has $600M contracted. Every other AV company with freight ambitions has not. The problem is not the technology ,  it is how freight buyers qualify new carriers."
  og_type: "article"
...
entities:
  primary_topic: "Autonomous Vehicle Commercial Barriers"
  secondary_topics:
    - "Freight Buyer Qualification"
    - "Cost-per-Mile Translation"
    - "AV Safety History"
    - "Fixed-Route Commercial Model"
    - "AV Revenue Structure"
...
citations:
  - id: "C1"
    type: "proprietary"
    title: "Problem_Proof_Matrix ,  On-Road Filter"
    publisher: "Autonomy Bridge proprietary research, 2024-2026"
    url: "internal"
  - id: "C2"
    type: "proprietary"
    title: "On-Road AV Company Research (32 companies)"
    publisher: "Autonomy Bridge proprietary research, 2026"
    url: "internal"
  - id: "C3"
    type: "proprietary"
    title: "Sector Research ,  On-Road AV Section"
    publisher: "Autonomy Bridge proprietary research, 2026"
    url: "internal"
  - id: "C4"
    type: "market"
    title: "Gatik Contracted Revenue and Fleet Data"
    publisher: "Gatik public disclosures, 2025-2026"
  - id: "C5"
    type: "market"
    title: "Waabi Series C Raise and Volvo Partnership Data"
    publisher: "Waabi public disclosures, January 2026"
  - id: "C6"
    type: "market"
    title: "Kodiak Robotics Permian Basin Deployment and ARM Data"
    publisher: "Kodiak public disclosures, 2025-2026"
  - id: "C7"
    type: "market"
    title: "EasyMile Pivot and Commercial Deployment Data"
    publisher: "EasyMile public disclosures, 2025-2026"
  - id: "C8"
    type: "market"
    title: "Oxa Series D and Industrial Pivot"
    publisher: "Oxa public disclosures, March 2026"
  - id: "C9"
    type: "market"
    title: "Einride Funding and IPO Data"
    publisher: "Einride public disclosures, February 2026"
  - id: "C10"
    type: "market"
    title: "Udelv Reservation and Production Plan Data"
    publisher: "Udelv public disclosures, 2021-2022; status as of 2026"
  - id: "C11"
    type: "market"
    title: "Conigital Liquidation"
    publisher: "Public record, February 2025"
  - id: "C12"
    type: "market"
    title: "Nuro Business Model Pivot and Funding Data"
    publisher: "Nuro public disclosures, 2024-2025"
  - id: "C13"
    type: "market"
    title: "May Mobility Partnerships and Deployment Data"
    publisher: "May Mobility public disclosures, 2025"
  - id: "C14"
    type: "market"
    title: "Vay Pricing and Service Data"
    publisher: "Vay public disclosures, 2025"
  - id: "C15"
    type: "market"
    title: "Embotech BMW and Port of Rotterdam Data"
    publisher: "Embotech public disclosures, 2025"
  - id: "C16"
    type: "market"
    title: "Sensible 4 Tampere Pilot Data"
    publisher: "Sensible 4 public disclosures, 2025"
  - id: "C17"
    type: "internal"
...
# What Autonomous Vehicle Companies Get Wrong About Freight Sales {#top}
...
**Decision Question:** Why aren't our technology milestones converting to freight contracts, and what does the freight buyer actually need to see before signing?
...
|---|---|---|
| SCS ,  Sales Cycle Stall | 8 | Enterprise sales cycles too long, burning cash before close |
| CC ,  Channel Constraint | 5 | Growth blocked at direct/founder-led sales |
| PTS ,  Pilot to Scale | 4 | Has pilots, cannot convert to fleet-scale production deals |
| PM ,  Pricing Mismatch | 4 | Pricing model does not match buyer budget architecture |
| QF ,  Qualification Failure | 2 | Targeting wrong buyer segments |
...
| Segment | Buyer | Qualification Criteria | Revenue Model | Commercial Status (2026) |
|---|---|---|---|---|
| B2B fixed-route middle-mile freight | Enterprise shippers (Walmart, Kroger, retailers) | Cost-per-mile on defined route, commercial safety record, carrier qualification | Per-mile contracted, fleet lease | Only proven segment ,  Gatik |
| Long-haul highway freight | Freight carriers, 3PLs | Cost-per-mile, FMCSA carrier safety rating, equipment compliance | Per-mile or fleet partnership | Pre-revenue; all companies at pilot or ARM threshold |
| Robotaxi / ride-hail | Consumers via platform | Reliability, service coverage, cost vs. human ride-hail | Per-ride, platform revenue share | Marginal; subsidy- or platform-dependent |
| Transit / shuttle / industrial campus | Municipalities, airports, OEM factories | Safety certification, regulatory approval, operational cost reduction | Fleet lease or service contract | Working for fixed-environment operators |
...
**Why aren't driverless miles converting to freight contracts?**
Freight buyers do not evaluate new carrier relationships based on accumulated driverless miles. They evaluate based on cost-per-mile on specific lanes versus current carrier rates, safety history recorded in the FMCSA carrier compliance system, and operational record on commercial freight routes. Driverless miles accumulated in test or demonstration operations do not build FMCSA carrier history and do not demonstrate route-specific cost-per-mile economics. The metric AV vendors present and the metric freight buyers use to qualify new carriers are structurally different. That gap is why sales cycles stall after technology briefings.

**What makes Gatik's commercial model work when others haven't?**
Gatik operates fully driverless middle-mile trucks on fixed routes for B2B enterprise shippers in Texas, Arkansas, and Arizona. The fixed-route, short-haul, geofenced structure allowed Walmart and Kroger to evaluate a specific cost-per-mile comparison on defined lanes and observe commercial operational history ,  60,000-plus driverless orders ,  before committing to fleet expansion. The model removed open-ended qualification variables: route variability, unexpected operational conditions, and unverifiable safety projections. Freight buyers approved what they could evaluate specifically, not what was projected generally.

**What is the freight carrier qualification barrier for AV companies?**
Freight carriers in the US are qualified through the FMCSA Safety Measurement System and Carrier Safety Fitness Determination process. Major shippers maintain approved-carrier lists based on carriers' safety records, compliance history, and performance data in the FMCSA system. A new carrier ,  AV or otherwise ,  has no history in that system and must accumulate commercial operational record before qualifying for preferred carrier programs. A technology demonstration does not build this record. Commercial operations generating real freight on commercial routes, reported through the carrier compliance infrastructure, build this record. The barrier requires time on commercial routes, not time on test courses.

**Why are fixed-environment deployments (factories, airports, ports) closing faster than highway freight?**
Fixed-environment buyers ,  factory managers, airport operators, port authorities ,  qualify autonomous vehicles against the specific operational requirements of their facility, not against the FMCSA carrier system. The cost-per-mile comparison in a factory is labor cost of manual vehicle movement versus autonomous service contract economics. A facility manager can make that comparison with a reference deployment at an equivalent facility. The qualification evidence is a reference site with verified operational reliability and cost reduction data. This is achievable without highway commercial operations history. Highway freight buyers require both route-specific cost-per-mile data and carrier safety history in the FMCSA system ,  a higher evidence threshold that takes longer to build.

**How should AV investors evaluate commercial progress?**

...
A pilot answers a narrow question: can the robot perform the task under controlled conditions. Scaling requires answering a different question: can the system maintain economic viability under real operating variability. Scaling failures occur when:
...
Operators use this framework during pilot evaluation to determine whether pilot results support a scaling decision. Key measurements include:

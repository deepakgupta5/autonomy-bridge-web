...
termId: "T21"
slug: "order-profile"
description: "The statistical distribution of order characteristics — lines per order, units per line, SKU mix, pack configuration — that defines the demand pattern an automation system must serve."
summary: "The statistical distribution of order characteristics — lines per order, units per line, SKU mix, pack configuration — that defines the demand pattern an automation system must serve. Order profile describes the shape of demand that a ware…"
definition: "The statistical distribution of order characteristics — lines per order, units per line, SKU mix, pack configuration — that defines the demand pattern an automation system must serve."
glossaryCategory: "robotics-systems"
contentType: "glossary"
status: "published"
canonicalPath: "/glossary/order-profile"
seoTitle: "Order Profile | Autonomy Bridge Glossary"
seoDescription: "The statistical distribution of order characteristics — lines per order, units per line, SKU mix, pack configuration — that defines the demand pattern an automation system must serve."
keywords:
  - "glossary"
  - "Robotics Systems"
frameworks:
...
draft: false
documentId: "doc_glossary_term_t21"
authors:
  - "Deepak Gupta"
...
**Related terms:** [sku-velocity](/glossary/sku-velocity) · pick-rates · demand-variability

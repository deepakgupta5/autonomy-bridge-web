...
description: "A high-density automated system that stores and retrieves inventory containers, totes, or cases using mechanized equipment — including crane-based systems, shuttle systems, and cu…"
...
definition: "A high-density automated system that stores and retrieves inventory containers, totes, or cases using mechanized equipment — including crane-based systems, shuttle systems, and cu…"
...
seoDescription: "A high-density automated system that stores and retrieves inventory containers, totes, or cases using mechanized equipment — including crane-based systems, shuttle systems, and cu…"
keywords:
  - "glossary"
  - "Robotics Systems"
frameworks:
...
**Related terms:** [goods-to-person-system](/glossary/goods-to-person-system) · [multi-shuttle-system](/glossary/multi-shuttle-system) · [capital-recovery-period](/glossary/capital-recovery-period) · [peak-to-average-ratio](/glossary/peak-to-average-ratio)

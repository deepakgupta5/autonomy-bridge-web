---
title: "Sortation Technology Fork"
term: "Sortation Technology Fork"
termId: "T77"
slug: "sortation-technology-fork"
description: "The binary architecture decision between fixed-conveyor sortation and AMR-based sortation that locks a parcel operator's cost structure and volume risk profile for seven to ten years."
summary: "The binary architecture decision between fixed-conveyor sortation and AMR-based sortation that locks a parcel operator's cost structure and volume risk profile for seven to ten years. The sortation technology fork is not a throughput specification decision — it is a risk profile decision that maps each architecture to a different failure mode under volume contraction or volume expansion."
definition: "The binary architecture decision between fixed-conveyor sortation and AMR-based sortation that locks a parcel operator's cost structure and volume risk profile for seven to ten years."
glossaryCategory: "deployment-economics"
contentType: "glossary"
status: "published"
canonicalPath: "/glossary/sortation-technology-fork"
seoTitle: "Sortation Technology Fork | Autonomy Bridge Glossary"
seoDescription: "The fixed-conveyor vs AMR-sortation decision that locks parcel sortation cost structure for 7–10 years. A risk profile decision, not a throughput specification comparison."
keywords:
  - "glossary"
...
relatedPages:
  ...
  - "/glossary/amr-sortation"
  - "/glossary/fixed-conveyor-sortation"
  - "/glossary/customer-concentration-risk"
draft: false
documentId: "doc_glossary_term_t77"
authors:
  - "Deepak Gupta"
...
migration:
  sourceFilename: "insight-2c-parcel-sortation.md"
  aipmVersion: "1.0"
---
...
**Related terms:** [sortation-volume-floor](/glossary/sortation-volume-floor) · [amr-sortation](/glossary/amr-sortation) · [fixed-conveyor-sortation](/glossary/fixed-conveyor-sortation) · [customer-concentration-risk](/glossary/customer-concentration-risk)
